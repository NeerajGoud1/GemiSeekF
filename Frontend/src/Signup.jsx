...
//   const [stage, setStage] = useState("enter-email"); // enter-email | enter-otp
//   const [busy, setBusy] = useState(false);
//   const [message, setMessage] = useState("");
//   const [error, setError] = useState("");
...
//       setStage("enter-otp");
//       setMessage("OTP sent — check your inbox (and spam).");
//       setOtp("");
//     } catch (err) {
...
//   // Verify OTP with backend, receive custom token, sign in with custom token
...
//             className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg font-semibold"
//           >
//             {busy ? "Verifying..." : "Verify OTP & Sign in"}
//           </button>
...
//               disabled={busy}
//               className="ml-auto text-slate-300 underline"
//             >
//               Resend OTP
//             </button>
//           </div>
